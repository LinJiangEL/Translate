...
if not os.path.exists("D:\\translate\\dict.txt"):
    with open("D:\\translate\\dict.txt", "w") as f:
        f.write("")
else:
    pass
...
class Youdao:
    def __init__(self, type=None, word=None):
        ...
        if not os.path.exists('D:\\translate\\Speech_US'):
            os.makedirs('D:\\translate\\Speech_US')
        if not os.path.exists('D:\\translate\\Speech_EN'):
            os.makedirs('D:\\translate\\Speech_EN')
    ...
    def play(word, audiotype):
        ...
        if audiotype == 'US':
            audiofile = 'D:/translate/Speech_US/' + word + '.mp3'
        elif audiotype == 'EN':
            audiofile = 'D:/translate/Speech_EN/' + word + '.mp3'
        else:
            audiofiles = ['D:/translate/Speech_US/' + word + '.mp3', 'D:\\translate\\Speech_EN\\' + word + '.mp3']
...
def get_reuslt(repsonse):
    ...
    ra = open("D:\\translate\\dict.txt", "r").readlines()
    a = open("D:\\translate\\dict.txt", "a+")
        ...
        if tran_choice == "common":
            for i in range(10):
                ...
                if word == "@SYSTEM exit":
                    ...
                    shutil.rmtree('D:\\translate\\Speech_US', ignore_errors=True)
                    shutil.rmtree('D:\\translate\\Speech_EN', ignore_errors=True)
                    os.makedirs('D:\\translate\\Speech_US')
                    os.makedirs('D:\\translate\\Speech_EN')
                else:
